...
- **Computer Vision** — focusing on object detection and tracking systems (e.g., YOLOv5 + StrongSORT)  
- **AI-based robotics control** — applying machine learning in real-world robot applications  
- **ROS2 development** — designing modular, scalable control and perception nodes  
- **Industrial robot programming** — working with collaborative arms and simulation environments (URSim, Gazebo)  

---

### Cognitive Synergy Architecture (CSA)

CSA (**Cognitive Synergy Architecture**) is not merely a research initiative —  
...
1️⃣ **Semantic Mapping & Memory** — YOLOv5 + StrongSORT + ORB-SLAM2 pipeline,  
   generating semantic maps and scene graphs stored in scalable formats (JSON, Neo4j-ready).  

2️⃣ **Self-Planning & Meta-Control** — combining learned policies (MLP, PPO)  
   with meta-controller logic for dynamic plan evaluation and adjustment.  

3️⃣ **Explainable Control** — integrating XAI (e.g., policy distillation, attention mechanisms)  
   to generate transparent, human-readable decision rationales.  

4️⃣ **Multi-Robot Execution** — enabling multi-robot systems with real-time synchronization,  
   multimodal inputs, and collaborative task allocation.  

5️⃣ **HRI & Common Ground** — employing multimodal intent recognition (gesture, speech, gaze)  
...
#### ⚡ CSA is My purpose on my career  
CSA is not just a project — it defines my **life mission** as a researcher and engineer.  
...
### 🏛️ Core Mechanical Engineering Disciplines  
| Area | Courses |
|-------|---------|
...
### 🌍 International Engineering Immersion — Germany (6 months)  
...
This experience was far more than travel — it was a **transformative learning journey**,  
...
### 🚀 Cognitive Synergy Architecture (CSA) — My Core Research  
...
#### Implementation  
- Full repository: [jack0682/CSAv1](https://github.com/jack0682/CSAv1.git)  
- Conceptual foundation: [arXiv:2505.03815 — Towards Cognitive Collaborative Robots](https://arxiv.org/abs/2505.03815)  
...
- This work reflects my comprehensive study of semantic mapping, cognitive planning,  
  explainable control, safety, and HRI — and serves as a scholarly foundation for my CSA implementation.

---

### ✈️ Autonomous Drone System Development  
As team lead for my university’s drone research group (affiliated with the Korean Society for Aeronautical Science):  
...
### 🦾 Soft Robotic Actuator Research  
